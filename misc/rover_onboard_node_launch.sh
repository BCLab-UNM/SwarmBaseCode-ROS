...
nohup rosrun apriltags_ros apriltag_detector_node __name:=$HOSTNAME\_TARGET /image_rect:=/$HOSTNAME/camera/image /camera_info:=/$HOSTNAME/camera/camera_info /tag_detections:=/$HOSTNAME/targets &
