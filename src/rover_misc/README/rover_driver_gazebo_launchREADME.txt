...
There are known problems that sometimes occur with the gazebo launch. Use Ctrl-C to quit out of the script and then make sure all of the processes are closed before starting the script again. A common error is that gzserver or gzclient is still running when you start the script.
