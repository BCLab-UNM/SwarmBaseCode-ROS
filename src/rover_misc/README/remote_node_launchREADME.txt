...
./remote_node_launch.sh [SWARMIE USERNAME] [HOSTNAME]

As of now, the Swarmie UserName is ksc. So, if I wanted to start the nodes on shemp I would type in a terminal window:
...
To change the packages and nodes that are launched, you will need to manually edit the rover_onboard_node_launch.sh script that is located on the Swarmies. A copy is also located in rover_scripts directory.
