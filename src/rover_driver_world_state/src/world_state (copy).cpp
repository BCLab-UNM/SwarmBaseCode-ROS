...
int pheremoneDecayTimer = 20; //seconds between decay cycle
...
// TODO: entire thing depends on moe being in the test, and only moe's parameters will be recorded.  This is a hack.
    ...
    pheremoneMapPublish = imgTransport.advertise((publishedName + "/map/pheremones"), 1, true);
    targetMapPublish = imgTransport.advertise((publishedName + "/map/targets"), 1, true);
